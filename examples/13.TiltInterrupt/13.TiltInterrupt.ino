 ...
 * @n and displays the tilt detection information.
...
void setup()
{
  ...
  Serial.println("\nTilt Detection Interrupt Example");
  ...
  Serial.print("[4] Configuring INT1 tilt detection interrupt... ");
  while (!imu.setInt(DFRobot_Multi_DOF_IMU::eImuIntPin1, DFRobot_Multi_DOF_IMU::eInt1_2Tilt)) {
...
#error
  ...
  Serial.println("Tip: Tilt sensor in any direction to trigger interrupt");
  Serial.println("     (Tilt angle needs to reach a certain threshold)");
