# -*- coding: utf-8 -*
'''!
@file  imu_6dof_polling.py
@brief  Read 6DOF IMU data example (accelerometer + gyroscope)
@details  This example demonstrates how to read 6DOF IMU sensor data using I2C or UART interface.
@n  The example initializes the sensor, configures the accelerometer and gyroscope ranges,
@n  then continuously reads and prints the 6DOF data (acceleration and angular velocity) in the loop function.
...
def setup():
  print("\n6DOF IMU Polling Example (%s mode)\n" % mode)
